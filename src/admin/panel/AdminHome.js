      ...
      <div className="cards">
        <div className="card">
          ...
          <div className="icon-box">
            <i className="logo" style={{ color: "lightblue" }}>
              <FaUsers />
            </i>
          </div>
        </div>
        <div className="card">
          ...
          <div className="icon-box">
            <i className="logo" style={{ color: "yellow" }}>
              <MdReportProblem />
            </i>
          </div>
        </div>
        <div className="card">
          <div className="card-content">
            <div className="number">
              {state.problems.reduce(
                (total, problem) => total + problem.likesUserId.length,
                0
              )}
            </div>
          ...
          <div className="icon-box">
            <i className="logo" style={{ color: "red" }}>
              <FaHeart />
            </i>
          </div>
        </div>
        <div className="card">
          <div className="card-content">
            <div className="number">
              {state.problems.reduce(
                (total, problem) => total + problem.comments.length,
                0
              )}
            </div>
          ...
          <div className="icon-box">
            <i className="logo" style={{ color: "cadetblue" }}>
              <FaComments />
            </i>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="number">
              {
                state.problems.filter((problem) => problem.isCompleted === true)
                  .length
              }
            </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="number">{state.categories.length}</div>

            <div className="card-name">Kategoriler </div>
          </div>
          <div className="icon-box">
            <i className="logo" style={{ color: "coral" }}>
              <BiSolidCategoryAlt />
            </i>
          </div>
        </div>
